...
@endphp
    ...
    <body
        ...
        <table class="wrapper" width="100%" cellpadding="0" cellspacing="0"
            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #00448A; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
            <tr>
                        ...
                        <tr>
                            <td class="header"
                                ...
                                <a href="{{ env('APP_URL') }}"
                                    ...
                                    <img src="{{ asset('img/logo.png') }}" id="logo-header" alt=""
                                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; max-width: 100%; border: none; width: 200px;">
                                </a>
                            </td>
                        </tr>
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                            <p
                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: -25px; text-align: center;">
                                                <a href=""
                                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #F58C46;"><img
                                                        src="" id="ad-image"
                                                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; min-width: 600px; border: none;"></a>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td class="content-cell" align="center"
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                            <p
                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: rgba(174, 174, 174, 0.788); font-size: 12px; text-align: center;">
                                                © {{ \Carbon\Carbon::now()->format('Y') }} {{ env('APP_NAME') }}. All rights
                                                reserved.</p>
                                        </td>
                                    </tr>
                                </table>
