...
<div className="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        { isLoggedIn()
          ...
          : (
            <>
              <a href="/" className="text-sm text-gray-700 underline">Home</a>
              <a href="/login" className="ml-4 text-sm text-gray-700 underline">Login</a>
              <a href="/register" className="ml-4 text-sm text-gray-700 underline">Register</a>
            </>
          )
        }
